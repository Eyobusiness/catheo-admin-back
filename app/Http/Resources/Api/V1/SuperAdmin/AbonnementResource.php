...
class AbonnementResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'organisation_nom'           => $this->organisation?->nom,
            'organisation_type'          => $this->organisation?->type_organisation,
            'mode'                       => $this->organisation ? ($this->organisation->mode ?? ($this->organisation->paroisse_configuration_id ? 'liee' : 'independant')) : 'liee',
