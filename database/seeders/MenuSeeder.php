        ...
        $menusStructure = [
            ...
            [
                ...
                'sousMenus' => [
                    ...
                    ['libelle' => 'Versements',             'path' => '/versements-cure',      'reference' => 'versements_cure',        'icon' => 'bi bi-bank',          'ordre' => 4],
                ],
            ],
            [
            ...
            [
                ...
                'sousMenus' => [
                    ...
                    ['libelle' => 'Groupes',                     'path' => '/groupes',                 'reference' => 'groupes',                 'icon' => 'bi bi-collection',     'ordre' => 5],
                    ['libelle' => 'Animateurs',                  'path' => '/animateurs',              'reference' => 'animateurs',              'icon' => 'bi bi-person-badge',   'ordre' => 6],
                    ['libelle' => 'Affectation des animateurs',  'path' => '/affectations-animateurs', 'reference' => 'affectations_animateurs', 'icon' => 'bi bi-person-check',   'ordre' => 7],
                    ['libelle' => 'CEB',                         'path' => '/cebs',                    'reference' => 'cebs',                    'icon' => 'bi bi-house-door',     'ordre' => 8],
                    ['libelle' => 'Mouvements',                  'path' => '/mouvements',              'reference' => 'mouvements',              'icon' => 'bi bi-flag',           'ordre' => 9],
                    ['libelle' => 'Calendrier',                  'path' => '/activites',               'reference' => 'calendrier_activites',    'icon' => 'bi bi-calendar4-week', 'ordre' => 10],
                    ['libelle' => 'Modules trimestriels',        'path' => '/modules-trimestriels',    'reference' => 'modules_trimestriels',    'icon' => 'bi bi-grid-3x3',       'ordre' => 11],
                ],
            ],
            [
